...
def city_by_state(state_id):
    ...
    :return: JSON list of all City objects in a state or 404 error if not found
    """
    city_list = []
...
def city_create(state_id):
    ...
    :param state_id: State object ID
    :return: JSON of the newly created City object with status code 201
    """
...
def city_by_id(city_id):
    ...
    :return: JSON of the City object with the specified ID
...
def city_put(city_id):
    ...
    :param city_id: City object ID
    :return: JSON of the updated City object or error codes 400/404
    """
    city_json = request.get_json(silent=True)
    if city_json is None:
        abort(400, 'Not a JSON')
